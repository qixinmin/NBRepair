    ...
    public partial class ReturnCustomInfoImportForm : Form
    {
        ...
        private void importButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlConnection queryConn = new SqlConnection(Conlist.ConStr);
                queryConn.Open();
                ...
                if (queryConn.State == ConnectionState.Open)
                {
                    ...
                    if (reportList.Count > 0)
                    {
                        ...
                        foreach(ReportCustomInfo temp in reportList)
                        {
                            ...
                            cmd.CommandText = "update OUTNBCHUKU set chukudate='" + temp.date.Trim() + "' where NBSerial='" + temp.track_no.Trim() + "'";
                            cmd.ExecuteNonQuery();
                        }
